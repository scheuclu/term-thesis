...
DefineConstant[ numele_x_per_sub = {3, Min 1, Max 1200, Step 1,
...
Physical Line("xy-clampline",1) = {linebottom[],linetop[]};
//Physical Line("neumann line right",2) = lineright[];
Physical Line("neumann line left",3) = lineleft[];
// Physical Line("neumann line left",3) = {22,26,30};
...
Physical Surface("sub7",107)=surface~{7}~{1}[];
Physical Surface("sub8",108)=surface~{8}~{1}[];

Physical Surface("sub9",109)=surface~{1}~{2}[];
Physical Surface("sub10",110)=surface~{2}~{2}[];
Physical Surface("sub11",111)=surface~{3}~{2}[];
Physical Surface("sub12",112)=surface~{4}~{2}[];
Physical Surface("sub13",113)=surface~{5}~{2}[];
Physical Surface("sub14",114)=surface~{6}~{2}[];
Physical Surface("sub15",115)=surface~{7}~{2}[];
Physical Surface("sub16",116)=surface~{8}~{2}[];

Physical Surface("sub17",117)=surface~{1}~{3}[];
Physical Surface("sub18",118)=surface~{2}~{3}[];
Physical Surface("sub19",119)=surface~{3}~{3}[];
Physical Surface("sub20",120)=surface~{4}~{3}[];
Physical Surface("sub21",121)=surface~{5}~{3}[];
Physical Surface("sub22",122)=surface~{6}~{3}[];
Physical Surface("sub23",123)=surface~{7}~{3}[];
Physical Surface("sub24",124)=surface~{8}~{3}[];*/
